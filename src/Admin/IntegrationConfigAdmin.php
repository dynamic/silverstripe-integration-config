...
namespace Dynamic\IntegrationConfig\Admin;
...
class IntegrationConfigAdmin extends LeftAndMain
{
    /**
     * @var string
     */
    private static $url_segment = 'Integration-config';
     ...
     * @var string
     */
    private static $menu_title = 'Integrations';
     ...
     * @var string
     */
    private static $tree_class = IntegrationConfigSetting::class;

    /**
     * @var array
     */
    private static $required_permission_codes = ['INTEGRATION_CONFIG_PERMISSION'];

    /**
     * Initialises the {@link IntegrationConfigSetting} controller.
     */
    ...
    {
        $config = IntegrationConfigSetting::current_Integration_config();
     ...
     * @return string
     */
    public function save_Integrationconfig($data, $form)
    {
        $config = IntegrationConfigSetting::current_Integration_config();
